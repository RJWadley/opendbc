...
def create_aeb_control(packer, fcw_active, aeb_active, accel, hill_hold_accel=0.0):
  hill_braking = hill_hold_accel != 0.0
  values = {
    ...
    "ANB_Teilbremsung_Freigabe": 1 if hill_braking else 0,  # Partial braking release
    "ANB_Zielbremsung_Freigabe": 0,  # Target braking release
    "ANB_Zielbrems_Teilbrems_Verz_Anf": hill_hold_accel if hill_braking else 0.0,  # Acceleration requirement for target/partial braking, m/s/s
