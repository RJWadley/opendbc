...
def create_acc_accel_control(packer, bus, acc_type, acc_enabled, accel, acc_control, stopping, starting,
  ...
  acc_06_values = {
    ...
    "ACC_StartStopp_Info": 0,
    "ACC_Sollbeschleunigung_02": 3.01,
    "ACC_zul_Regelabw_unten": 0,
    "ACC_zul_Regelabw_oben": 0,
    "ACC_neg_Sollbeschl_Grad_02": 0,
    "ACC_pos_Sollbeschl_Grad_02": 0,
    "ACC_Anfahren": False,
    "ACC_Anhalten": False,
  }
  if acc_enabled:
    acc_06_values.update({
      "ACC_StartStopp_Info": 1,
      ...
      "ACC_neg_Sollbeschl_Grad_02": 4.0,  # TODO: dynamic adjustment of jerk limits
      "ACC_pos_Sollbeschl_Grad_02": 4.0,  # TODO: dynamic adjustment of jerk limits
