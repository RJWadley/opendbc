...
def create_acc_accel_control(packer, bus, acc_type, acc_enabled, accel, acc_control, stopping, starting, esp_hold,
  ...
  acc_06_values = {
    ...
    "ACC_zul_Regelabw_unten": 0 if starting or stopping else 0.2,  # TODO: dynamic adjustment of comfort-band
    "ACC_zul_Regelabw_oben": 0 if starting or stopping else 0.2,  # TODO: dynamic adjustment of comfort-band
  ...
  acc_07_values = {
    ...
    "ACC_Anfahren": acc07_starting,
    "ACC_Anhalten": acc07_stopping,
  }
