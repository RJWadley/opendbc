...
def create_acc_accel_control(packer, bus, acc_type, acc_enabled, accel, acc_control, stopping, starting, esp_hold, reset_signal):
  ...
  acc_06_values = {
    ...
    "ACC_Anfahren": starting_6 if acc_enabled else False,
    "ACC_Anhalten": stopping_6 if acc_enabled else False,
  }
  ...
  acc_07_values = {
    "ACC_Anhalteweg": 0.3 if stopping_7 else 20.46,  # Distance to stop (stopping coordinator handles terminal roll-out)
    ...
    "ACC_Anfahren": starting_7 if acc_enabled else False,
    "ACC_Anhalten": stopping_7 if acc_enabled else False,
  }
